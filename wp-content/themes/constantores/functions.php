 ...
 */
function constantores_resource_hints( $urls, $relation_type ) {
	if ( wp_style_is( 'constantores-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		$urls[] = array(
 ...
 */
function constantores_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'constantores' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'constantores' ),
...
add_action( 'widgets_init', 'constantores_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'constantores_scripts' );
